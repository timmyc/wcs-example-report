...
var ExtensionReport = function (_Component) {
	babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(ExtensionReport, _Component);

	function ExtensionReport() {
		babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, ExtensionReport);
	...
	babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(ExtensionReport, [{
		...
		value: function getHeadersContent() {
			return [{
				label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('Date', 'wc-admin'),
				key: 'date_start',
				required: true,
				defaultSort: true,
				isSortable: true
		...
		value: function getRowsContent() {
			...
			return Object(lodash__WEBPACK_IMPORTED_MODULE_9__["map"])(labels, function (row) {
				...
				var orderLink = wp.element.createElement(
					'a',
					{ href: '/wp-admin/post.php?action=edit&post=' + order_id },
					order_id
				);
		...
		value: function renderPlaceholder() {
			var headers = this.getHeadersContent();
			return wp.element.createElement(
				_woocommerce_components__WEBPACK_IMPORTED_MODULE_8__["Card"],
				{
					title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('Shipping Labels', 'wc-admin'),
					className: 'wcs-example-report-placeholder'
				},
				wp.element.createElement(_woocommerce_components__WEBPACK_IMPORTED_MODULE_8__["TablePlaceholder"], { caption: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('Shipping Labels', 'wc-admin'), headers: headers })
			);
		}
	}, {
		key: 'renderTable',
		value: function renderTable() {
			...
			var rows = this.getRowsContent() || [];

			var headers = this.getHeadersContent();

			var tableQuery = babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, query, {
				orderby: query.orderby || 'date_start',
				order: query.order || 'asc'
			});
			return wp.element.createElement(_woocommerce_components__WEBPACK_IMPORTED_MODULE_8__["TableCard"], {
				title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_6__["__"])('Shipping Labels', 'wc-admin'),
				rows: rows,
