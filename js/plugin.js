...
/******/ 	return __webpack_require__(__webpack_require__.s = "./js/src/plugin.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _report__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./report */ "./js/src/report.js");
...
Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_1__["addFilter"])('woocommerce-reports-list', 'wcs-labels/labels', function (pages) {
	return [].concat(babel_runtime_helpers_toConsumableArray__WEBPACK_IMPORTED_MODULE_0___default()(pages), [{
		report: 'wcs-labels',
		title: 'Labels',
		component: _report__WEBPACK_IMPORTED_MODULE_2__["default"]
	}]);
});
...
var ExtensionReport = function (_Component) {
	babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_4___default()(ExtensionReport, _Component);

	function ExtensionReport() {
		babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, ExtensionReport);

		return babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3___default()(this, (ExtensionReport.__proto__ || babel_runtime_core_js_object_get_prototype_of__WEBPACK_IMPORTED_MODULE_0___default()(ExtensionReport)).apply(this, arguments));
	}

	babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(ExtensionReport, [{
		key: 'componentDidMount',
		value: function componentDidMount() {
			// This should be handled for us automagically, but the nonce wasn't working for me
			_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5__["default"].use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5__["default"].createNonceMiddleware(wcSettings.nonce));
			_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5__["default"].use(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5__["default"].createRootURLMiddleware(wcSettings.api_root));
			Object(_wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_5__["default"])({ path: 'wc/v3/reports/labels' }).then(function (labels) {
				console.log(labels);
			});
		}
	}, {
		...
		value: function render() {
			...
			return wp.element.createElement(
				...
				null,
				wp.element.createElement(_woocommerce_components__WEBPACK_IMPORTED_MODULE_6__["ReportFilters"], { path: this.props.path }),
				wp.element.createElement(
					_woocommerce_components__WEBPACK_IMPORTED_MODULE_6__["Card"],
					{ title: 'Extension' },
					wp.element.createElement(
						'p',
						null,
						...
						'. The ReportFilters above is also imported from ',
						wp.element.createElement(
							'code',
							null,
							'wc-admin'
...
/* harmony default export */ __webpack_exports__["default"] = (ExtensionReport);
...
/* harmony import */ var _middlewares_nonce__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./middlewares/nonce */ "./node_modules/@wordpress/api-fetch/build-module/middlewares/nonce.js");
/* harmony import */ var _middlewares_root_url__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./middlewares/root-url */ "./node_modules/@wordpress/api-fetch/build-module/middlewares/root-url.js");
/* harmony import */ var _middlewares_preloading__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./middlewares/preloading */ "./node_modules/@wordpress/api-fetch/build-module/middlewares/preloading.js");
...
function apiFetch(options) {
  var raw = function raw(nextOptions) {
    var url = nextOptions.url,
        ...
        remainingOptions = Object(_babel_runtime_helpers_esm_objectWithoutProperties__WEBPACK_IMPORTED_MODULE_3__["default"])(nextOptions, ["url", "path", "body", "data", "parse"]);
    ...
    var responsePromise = window.fetch(url || path, Object(_babel_runtime_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_2__["default"])({}, remainingOptions, {
      credentials: 'include',
    ...
    return responsePromise.then(checkStatus).then(parseResponse).catch(function (response) {
      ...
      var invalidJsonError = {
        code: 'invalid_json',
        message: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('The response is not a valid JSON response.')
      };
      ...
      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
        ...
        var unknownError = {
          code: 'unknown_error',
          message: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('An unknown error occurred.')
        };
  ...
  var steps = [raw, _middlewares_http_v1__WEBPACK_IMPORTED_MODULE_9__["default"], _middlewares_namespace_endpoint__WEBPACK_IMPORTED_MODULE_8__["default"]].concat(middlewares);
...
apiFetch.createNonceMiddleware = _middlewares_nonce__WEBPACK_IMPORTED_MODULE_5__["default"];
apiFetch.createPreloadingMiddleware = _middlewares_preloading__WEBPACK_IMPORTED_MODULE_7__["default"];
apiFetch.createRootURLMiddleware = _middlewares_root_url__WEBPACK_IMPORTED_MODULE_6__["default"];
